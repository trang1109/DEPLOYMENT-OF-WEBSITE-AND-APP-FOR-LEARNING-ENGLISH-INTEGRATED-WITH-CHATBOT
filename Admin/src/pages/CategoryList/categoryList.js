        ...
        },
        {
            ...
            render: (text, record) => (
                <div style={{ display: 'flex', flexDirection: 'column' }}>
                    ...
                    <Popconfirm
                        title="Bạn có chắc chắn xóa chủ đề này?"
                            ...
                            >
                                <Row>
                                    ...
                                    <Col span="6">
                                        <Row justify="end">
                                            <Space>
                                                <Button onClick={showModal} icon={<PlusOutlined />} style={{ marginLeft: 10 }} >Tạo chủ đề</Button>
                                            </Space>
                                        </Row>
                                    </Col>
                                </Row>
